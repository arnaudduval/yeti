...
!! with Yeti. if not, see <https://www.gnu.org/licenses/>
      ...
      subroutine generateVTU(FILENAME, FieldOutput_flag, nb_refinement,
     1     SOL, COORDS3D, IEN, nb_elem_patch, Nkv, Ukv, Nijk, weight, 
     2     Jpqr, ELT_TYPE, MATERIAL_PROPERTIES, TENSOR, PROPS, JPROPS, 
     3     NNODE, nb_patch, nb_elem, nb_cp, MCRD)
...
c     test embedded stiff
      ...
      write(*, *)' --> File ' // FILENAME // '.vtu has been created.'
