...
subroutine Gauss (norder,dim,GaussWtCoord,iFace)
    ...
    select case (norder)
        ...
        case(10)
            ...
            weight(2) = 0.1494513491505806
            weight(3) = 0.2190863625159820
            weight(4) = 0.2692667193099963
            weight(5) = 0.2955242247147529
            weight(6) = 0.2955242247147529
            weight(7) = 0.2692667193099963
            weight(8) = 0.2190863625159820
            weight(9) = 0.1494513491505806
            weight(10) = 0.0666713443086881
        case(11)
            xi(1) = -0.9782286581460570
            xi(2) = -0.8870625997680953
            xi(3) = -0.7301520055740494
            xi(4) = -0.5190961292068118
            xi(5) = -0.2695431559523450
            xi(6) =  0.0D0
            xi(7) =  0.2695431559523450
            xi(8) =  0.5190961292068118
            xi(9) =  0.7301520055740494
            xi(10) = 0.8870625997680953
            xi(11) = 0.9782286581460570

            weight(1) = 0.0556685671161737
            weight(2) = 0.1255803694649046
            weight(3) = 0.1862902109277343
            weight(4) = 0.2331937645919905
            weight(5) = 0.2628045445102467
            weight(6) = 0.2729250867779006
            weight(7) = 0.2628045445102467
            weight(8) = 0.2331937645919905
            weight(9) = 0.1862902109277343
            weight(10) = 0.1255803694649046
            weight(11) = 0.0556685671161737
