...
!! with Yeti. If not, see <https://www.gnu.org/licenses/>
     ...
     2     TENSOR,MATERIAL_PROPERTIES,DENSITY,PROPS,JPROPS,nb_load,
     3     indDLoad,load_target_nbelem,JDLType,ADLMAG,
     4     load_additionalInfos,nb_load_additionalInfos,
     5     computeWint,computeWext,gradWint_elem,gradWext_elem)
...
c     Computing adjoint strain and stress
         strainAdj(:,:) = zero
         stressAdj(:,:) = zero
         Do iA = 1,nadj
             Do ij = 1,ntens
...
c     - centrifugal load
    ...
    !               Enddo
     ...
     &                    + dfdP_UA(:,iA)*Area*detJac
      ...
      Enddo
c     End of the loop on integration points
