...
c     polygone de controle d'une geometrie NURBS avec Paraview
      ...
      Subroutine generate_vtk(case_name, COORDS3D, nb_cp_dir, nb_cp)
...
c     Ecriture du fichier
      open(90, file='results/' //  case_name // '.vtk',form='formatted')
...
c     --> cas avec solution
      ...
      Subroutine generate_vtk_wSOL(case_name,COORDS3D,SOL3D,nb_cp_dir,
     &     nb_cp)
