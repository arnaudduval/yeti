...
subroutine generate_proj_vtu(filename, nb_refinement, sol, rhs, coords3D, ien, &
    ...
    do ipatch = 1, nb_patch
        ...
        if ((elt_type_patch .eq. 'U1') .or. (elt_type_patch .eq. 'U2') &
            ...
            open(91, file='results/'// filename // '_' // char_ipatch //'.vtu', &
                &   form='formatted')
            !! Header
            ...
            !! Write on screen
            write(*,*) ' --> File ' // filename // '_' // char_ipatch // '.vtu has been created.'
