...
if FIG_CASE == 0:
	...
	if PLOTRELATIVE:
		filename1 = folder + '1incheatRel'+lastsufix
		filename2 = folder + '1sptheatRel'+lastsufix
	else:
		filename1 = folder + '1incheatAbs'+lastsufix
		filename2 = folder + '1sptheatAbs'+lastsufix
	...
	if PLOTRELATIVE:
		filename1 = folder + '1incheatRel2'+lastsufix
		filename2 = folder + '1sptheatRel2'+lastsufix
	else:
		filename1 = folder + '1incheatAbs2'+lastsufix
		filename2 = folder + '1sptheatAbs2'+lastsufix
