...
from lib.create_model import eval_basis, create_knotvector
from lib.methods_iga import iga_find_positions_weights
from lib.methods_wq import wq_find_basis_weights_opt
...
for varName in ['I00', 'I01', 'I10', 'I11']:
    ...
    for degree in range(2, 6):
        ...
        for nb_el in NBEL: 
            ...
            # Calculate I
            I00f = W00f @ B0f.transpose()
            I01f = W01f @ B1f.transpose()
            I10f = W10f @ B0f.transpose()
            I11f = W11f @ B1f.transpose()
            ...
            # Calculate I
            I00p = W00p @ B0p.transpose()
            I01p = W01p @ B1p.transpose()
            I10p = W10p @ B0p.transpose()
            I11p = W11p @ B1p.transpose()
