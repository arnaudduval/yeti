...
SUFIX = 'linear' if ISLINEAR else 'nonlin'
...
# 	SUFIX = 'linear' if ISLINEAR else 'nonlin'
# 	figname = folder + 'Convergence'+SUFIX+'.pdf'
...
# 		table = np.loadtxt(folder+filename+SUFIX+EXTENSION)	
# 		nbels = 2**(table[0, 1:])
# 		degList = table[1:, 0]
# 		errList  = table[1:, 1:]
# 		for i, degree in enumerate(degList):
...
# 	filenameA1 = folder + '1incheatAbs2'+SUFIX
# 	filenameR1 = folder + '1incheatRel2'+SUFIX
# 	filenameT1 = folder + '1incheatTim2'+SUFIX

# 	filenameA2 = folder + '1sptheatAbs2'+SUFIX
# 	filenameR2 = folder + '1sptheatRel2'+SUFIX
# 	filenameT2 = folder + '1sptheatTim2'+SUFIX
...
# 	if PLOTRELATIVE:
# 		filename1 = folder + '1incheatRel'+SUFIX
# 		filename2 = folder + '1sptheatRel'+SUFIX
# 	else:
# 		filename1 = folder + '1incheatAbs'+SUFIX
# 		filename2 = folder + '1sptheatAbs'+SUFIX
...
# 	if PLOTRELATIVE:
# 		filename1 = folder + '1incheatRel2'+SUFIX
# 		filename2 = folder + '1sptheatRel2'+SUFIX
# 	else:
# 		filename1 = folder + '1incheatAbs2'+SUFIX
# 		filename2 = folder + '1sptheatAbs2'+SUFIX
...
# 	if PLOTRELATIVE: errorList1 = np.loadtxt(folder+'2relerrorstag_spt'+EXTENSION)
# 	else: errorList1 = np.loadtxt(folder+'2abserrorstag_spt'+EXTENSION)
...
# 	if PLOTRELATIVE: errorList1 = np.loadtxt(folder+'2relerrorstag_inc'+EXTENSION)
# 	else: errorList1 = np.loadtxt(folder+'2abserrorstag_inc'+EXTENSION)
...
# 	if PLOTRELATIVE: 
# 		ax.set_ylabel('Min. rel. error in '+r'$L^2(\Pi)$' +'-norm')
# 		ax.set_ylim(top=1e0, bottom=1e-9)
# 	else: 
