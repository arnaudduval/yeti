...
for quadrule, quadtype in zip(['iga'], ['leg']):
	...
	for i, degree in enumerate(degree_list):
		for j, cuts in enumerate(cuts_list):
			...
			if geoName == 'TR':
				error_list[j] = problem.normOfError(temperature, normArgs={'exactFunction':exactTemperature_thickRing})
			elif geoName == 'RQA':
				error_list[j] = problem.normOfError(temperature, normArgs={'exactFunction':exactTemperature_rotRing})
