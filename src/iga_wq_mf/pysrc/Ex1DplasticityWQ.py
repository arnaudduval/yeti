...
# Solve 
disp, epn, sigma, energy, internal = solve_plasticity_1D(properties, DB=DB, DW=DW, Fext=Fext, dof=dof)
epn_cp   = interpolate_controlPoints_1D(DB, DW, epn)
sigma_cp = interpolate_controlPoints_1D(DB, DW, sigma)
