...
def exactTemperature_inc(args):
	...
	elif GEONAME == 'SQ': func = exactTemperatureSquare_inc(args)
...
def exactTemperature_spt(args):
	...
	elif GEONAME == 'SQ': func = exactTemperatureSquare_spt(args)
...
def powerDensity_inc(args):
	...
	elif GEONAME == 'SQ': func = powerDensitySquare_inc(args)
...
def powerDensity_spt(args):
	...
	elif GEONAME == 'SQ': func = powerDensitySquare_spt(args)
	elif GEONAME == 'TP': func = powerDensityTrap_spt(args)
	return func
