...
if not dataExist:
	...
	for i in range(4): ax.loglog(file.nbel**3, CPUtime[:, i], '--', label='degree ' + r'$p=$' + str(i+2), marker=MARKERLIST[i])
	...
	ax.set_xticks([1e4, 64**3, 128**3, 256**3, 512**3, 1e9])
	ax.set_xticklabels([r'$10^4$', r'$64^3$', r'$128^3$', r'$256^3$', r'$512^3$', r'$10^9$'])
	# ax.set_xticks([32**3, 64**3, 128**3, 256**3, 512**3])
	# ax.set_xticklabels([r'$32^3$', r'$64^3$', r'$128^3$', r'$256^3$', r'$512^3$'])
	ax.minorticks_off()
