...
subroutine mf_wq_get_cu_3d( nb_cols_total, capacity_coefs, &
    ...
    size_data_v, indi_T_v, indj_T_v, data_BT_v(:, 1), size_data_w, indi_T_w, indj_T_w, data_BT_w(:, 1), & 
    ...
    nb_rows_v, nb_cols_v, nb_rows_w, nb_cols_w, size_data_u, indi_u, indj_u, data_W_u(:, 1), &
    size_data_v, indi_v, indj_v, data_W_v(:, 1), size_data_w, indi_w, indj_w, data_W_w(:, 1), &
...
subroutine mf_wq_get_cu_3d_csr( nb_rows_total, nb_cols_total, capacity_coefs, &
    ...
    dimension ::    data_BT_u(size_data_u, 2), &
                    data_BT_v(size_data_v, 2), &
                    data_BT_w(size_data_w, 2)
    ...
    do j = 1, 3
        ...
        do i = 1, 3
            ...
            call tensor3d_dot_vector_sp(nb_rows_u, nb_cols_u, &
                ...
                size_data_v, indi_v, indj_v, data_W_v(:, zeta(2)), size_data_w, indi_w, indj_w, data_W_w(:, zeta(3)), & 
...
subroutine wq_mf_interp_3d(nb_rows_total, nb_cols_total, coefs, &
    ...
    ! Initialize
    call csr2csc(nb_rows_u, nb_cols_u, size_data_u, data_B_u, indj_u, indi_u, data_BT_u, &
                    indj_T_u, indi_T_u)
    call csr2csc(nb_rows_v, nb_cols_v, size_data_v, data_B_v, indj_v, indi_v, data_BT_v, &
                    indj_T_v, indi_T_v)
    call csr2csc(nb_rows_w, nb_cols_w, size_data_w, data_B_w, indj_w, indi_w, data_BT_w, &
                    indj_T_w, indi_T_w)
