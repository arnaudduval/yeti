...
subroutine mf_wq_interpolate_cp_3d_v2(coefs, nr_total, nc_total, nr_u, nc_u, nr_v, nc_v, nr_w, nc_w, &
    ...
    ! Fast diagonalization
    double precision, dimension(:), allocatable :: Mcoef_u, Mcoef_v, Mcoef_w, Kcoef_u, Kcoef_v, Kcoef_w, Kdiag, Mdiag, eigen_diag
    double precision :: U_u, U_v, U_w, D_u, D_v, D_w
    dimension :: U_u(nr_u, nr_u), U_v(nr_v, nr_v), U_w(nr_w, nr_w), D_u(nr_u), D_v(nr_v), D_w(nr_w)
    ...
    call set_capacity_coefs(mat, nc_total, coefs)
...
end subroutine mf_wq_interpolate_cp_3d_v2
