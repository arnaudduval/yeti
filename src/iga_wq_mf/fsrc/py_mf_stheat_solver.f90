...
subroutine mf_stcapacityders_2d(nr_total, nc_total, nc_sp, nc_tm, nr_u, nc_u, nr_v, nc_v, nr_t, nc_t, &
                        nnz_u, nnz_v, nnz_t, indi_u, indj_u, indi_v, indj_v, &
                        indi_t, indj_t, data_B_u, data_B_v, data_B_t, data_W_u, data_W_v, &
                        data_W_t, invJ, detJ, detG, prop, array_in, array_out)
    ...
    call setup_geometry(mat, dimen_sp, size(detJ), size(detG), invJ, detJ, detG)
    call setup_capacitydersprop(mat, size(prop), prop)
    call mf_u_v(mat, basisdata, nr_total, array_in, array_out)

end subroutine mf_stcapacityders_2d

subroutine mf_stcapacityders_3d(nr_total, nc_total, nc_sp, nc_tm, nr_u, nc_u, nr_v, nc_v, nr_w, nc_w, nr_t, nc_t, &
                        nnz_u, nnz_v, nnz_w, nnz_t, indi_u, indj_u, indi_v, indj_v, indi_w, indj_w, &
                        indi_t, indj_t, data_B_u, data_B_v, data_B_w, data_B_t, data_W_u, data_W_v, &
                        data_W_w, data_W_t, invJ, detJ, detG, prop, array_in, array_out)
...
end subroutine mf_stcapacityders_3d
...
subroutine mf_stconductivityders_2d(nr_total, nc_total, nc_sp, nc_tm, nr_u, nc_u, nr_v, nc_v, nr_t, nc_t, &
                        nnz_u, nnz_v, nnz_t, indi_u, indj_u, indi_v, indj_v, &
                        indi_t, indj_t, data_B_u, data_B_v, data_B_t, data_W_u, data_W_v, &
                        data_W_t, invJ, detJ, detG, prop, array_in, array_out)
    ...
    ! -------------------
    integer, parameter :: dimen_sp = 2
    integer, intent(in) :: nr_total, nc_total, nc_sp, nc_tm, nr_u, nc_u, nr_v, nc_v, nr_t, nc_t, &
                            nnz_u, nnz_v, nnz_t    
    integer, intent(in) :: indi_u, indi_v, indi_t
    dimension :: indi_u(nr_u+1), indi_v(nr_v+1), indi_t(nr_t+1)
    integer, intent(in) ::  indj_u, indj_v, indj_t
    ...
    double precision, intent(in) :: invJ, detJ, detG, prop
    dimension :: invJ(dimen_sp, dimen_sp, nc_sp), detJ(nc_sp), &
                detG(nc_tm), prop(dimen_sp, nc_total)
    double precision, intent(in) :: array_in
    dimension :: array_in(nr_total)
    ...
    call getcsr2csc(basisdata)
    call setup_geometry(mat, dimen_sp, size(detJ), size(detG), invJ, detJ, detG)
    call setup_conductivityDersprop(mat, nc_total, prop)
    call mf_gradx_u_v(mat, basisdata, nr_total, array_in, array_out)

end subroutine mf_stconductivityders_2d

subroutine mf_stconductivityders_3d(nr_total, nc_total, nc_sp, nc_tm, nr_u, nc_u, nr_v, nc_v, nr_w, nc_w, nr_t, nc_t, &
                        nnz_u, nnz_v, nnz_w, nnz_t, indi_u, indj_u, indi_v, indj_v, indi_w, indj_w, &
                        indi_t, indj_t, data_B_u, data_B_v, data_B_w, data_B_t, data_W_u, data_W_v, &
                        data_W_w, data_W_t, invJ, detJ, detG, prop, array_in, array_out)
...
end subroutine mf_stconductivityders_3d
