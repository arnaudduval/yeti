...
subroutine mf_wq_get_Au_shl_3d(coefs, nr_total, nc_total, nr_u, nc_u, nr_v, nc_v, nr_w, nc_w, nnz_u, nnz_v, nnz_w, &
...
end subroutine fd_shl_3d

subroutine mf_wq_solve_shl_3d(coefs, nr_total, nc_total, nr_u, nc_u, nr_v, nc_v, nr_w, nc_w, &
