...
subroutine fd_shs_3d(nr_total, nr_u, nr_v, nr_w, U_u, U_v, U_w, eigendiag, pardiag, phydiag, method, &
    ...
    if (method.eq.'WP') then 
        ...
        if (nbIter.gt.0) then
            ...
            do iter = 1, nbIter
                ...
                call fd_shs_3d(nr_total, nr_u, nr_v, nr_w, U_u, U_v, U_w, Deigen, Dparametric, Dphysical, method, &
