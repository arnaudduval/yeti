...
iga_model = IGAparametrization(filename='base_geom_half')
...
iga_model._indDLoad = np.array([np.array([6,7]),np.array([6,7])])
iga_model._JDLType = np.array([62,63])
iga_model._ADLMAG = np.array([1.190, 7.143])
iga_model._load_target_nbelem = np.array([2, 2])
...
# additional_knots = {'patches': np.array([0]),
#                     '1': np.array([0.1075, 0.215, 0.785, 0.8925]),
