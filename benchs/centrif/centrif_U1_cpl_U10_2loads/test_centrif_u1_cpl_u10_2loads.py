...
1 U1 patch couples with 1 U10 patch, 2 loads (1 one each patch)
"""
...
def test_centrif_u1_cpl_u10_2load(tmp_path):
    """
    ...
    iga_model = IGAparametrization(
        filename=f'{script_dir}/centrif_U1_cpl_U10_2loads')
...
if __name__ == '__main__':
    test_centrif_u1_cpl_u10_2load('results')
