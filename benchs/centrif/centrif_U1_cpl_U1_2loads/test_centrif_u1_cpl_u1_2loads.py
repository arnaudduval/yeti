...
2 coupled U1 patchs, 2 loads (1 one each patch)
"""
...
def test_centrif_u1_cpl_u1_2loads(tmp_path):
    """
    ...
    iga_model = IGAparametrization(
        filename=f'{script_dir}/centrif_U1_cpl_U1_2loads')
...
if __name__ == '__main__':
    test_centrif_u1_cpl_u1_2loads('results')
