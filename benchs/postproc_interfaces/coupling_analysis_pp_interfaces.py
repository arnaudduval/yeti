...
additional_knots = {"patches":np.array([1]),"1":np.array([]),"2":np.array([]),"3":np.array([0.25])} 
...
pp.generate_coupling_vtu(*modeleIGA.get_inputs4postproc_cplg_vtu('interfaces_10', 10, SOL.transpose(), nb_ref=np.array([3,3])))
pp.generate_coupling_vtu(*modeleIGA.get_inputs4postproc_cplg_vtu('interfaces_11', 11, SOL.transpose(), nb_ref=np.array([3,3])))
pp.generate_coupling_vtu(*modeleIGA.get_inputs4postproc_cplg_vtu('interfaces_12', 12, SOL.transpose(), nb_ref=np.array([3,3])))
