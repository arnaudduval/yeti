...
def test_gradcomp_embdsol_cube_nonli_hull_embd_ressure():
    """
    Compute gradients and compare values
    """
    script_dir = os.path.dirname(os.path.realpath(__file__))
    iga_model = IGAparametrization(
        filename=f'{script_dir}/embd_cube_nonli_hull_embd_press')
    ...
    nb_var = 18 * 3      # 18 control points x 3 directions
...
if __name__ == "__main__":
    test_gradcomp_embdsol_cube_nonli_hull_embd_ressure()
