...
differences
Design variables drive the control point of embedded entity except the loaded
face.
"""
...
if __name__ == "__main__":
    ...
    for i_var in range(nb_var)[81:135]:
    ...
    error = np.linalg.norm(gradC_DF[81:135] - gradC_AN[81:135])/c0
