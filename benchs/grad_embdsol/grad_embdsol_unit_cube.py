...
modeleIGA = IGAparametrization(filename='unit_cube_lin')
...
def shapemodif(coords0, igapara, var):
    ...
    igapara._COORDS[2, 9] = initcoords[2, 9] + var[2]
    igapara._COORDS[0, 11] = initcoords[0, 11] + var[3]
    igapara._COORDS[1, 11] = initcoords[1, 11] + var[4]
